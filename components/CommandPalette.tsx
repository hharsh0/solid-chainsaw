...
function CommandPalette({navigation}:any) {
            ...
            >
              <div className="flex items-center px-4">
                ...
                <Combobox.Input
                  ...
                  className="h-12 ml-4 border-0 bg-transparent outline-none  text-sm text-gray-800 placeholder-gray-400 focus:ring-0 dark:text-neutral-400"
                  placeholder="Search..."
                  autoComplete="off"
                />
              </div>
              {filterednavigation.length > 0 && (
                ...
                >
                  {filterednavigation.map((page:any) => (
